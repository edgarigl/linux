...
PCIE="-device xlnx-pcie-rp,bus=pcie.0,id=pcie.1,port=1,chassis=1 -device pci-bridge,addr=00.0,bus=pcie.1,id=pcie.2,chassis_nr=2 -netdev user,id=hostnet1,net=10.0.3.0/24 -device e1000e,bus=pcie.2,addr=01.0,netdev=hostnet1,romfile="
